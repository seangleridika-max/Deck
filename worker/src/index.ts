...
router.get('/users/profile', authMiddleware, (request, env) => handleUsers.getProfile(request.userId, env));
router.get('/users/stats', authMiddleware, (request, env) => handleUsers.getStats(request.userId, env));
